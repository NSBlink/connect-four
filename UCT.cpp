...
//  Strategy
//
//  Created by 余欣健 on 16/5/18.
//  Copyright © 2016年 Yongfeng Zhang. All rights reserved.
//
#include "UCT.h"
...
Node* UCT::UCTSearch(int **boardStart, int *topStart)
{
    ...
    seconds  = endTime.tv_sec  - startTimeReal.tv_sec;
    useconds = endTime.tv_usec - startTimeReal.tv_usec;
    mtime = ((seconds) * 1000 + useconds/1000.0) + 0.5;
    srand(time(NULL));
    
    while(mtime < TIME_LIMIT)
    {
        times++;
